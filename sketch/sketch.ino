...
#define SUCCESS_SECONDS_TO_SLEEP 21600 // How long ESP32 will be in deep sleep (in seconds)
...
bool doDeepSleep()
{
    Serial.printf("SUCCESS! Going to sleep for %d...", SUCCESS_SECONDS_TO_SLEEP);   
